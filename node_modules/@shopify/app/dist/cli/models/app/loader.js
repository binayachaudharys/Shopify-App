...
import { error, file, path, string, toml, output } from '@shopify/cli-kit';
...
class AppLoader {
    ...
    async loadUIExtensions(extensionDirectories) {
        ...
        const extensions = configPaths.map(async (configurationPath) => {
            ...
            if (!specification) {
                this.abortOrReport(output.content `Unknown extension type ${output.token.yellow(type)} in ${output.token.path(configurationPath)}.`, undefined, configurationPath);
                return undefined;
            }
