...
export declare function getExtensionPointMiddleware({ devOptions }: GetExtensionsMiddlewareOptions): (request: http.IncomingMessage, response: http.ServerResponse, _next: (err?: Error | undefined) => unknown) => Promise<void>;
