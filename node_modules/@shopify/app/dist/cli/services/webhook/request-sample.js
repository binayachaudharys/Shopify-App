 ...
 */
export async function getWebhookSample(topic, apiVersion, deliveryMethod, address, sharedSecret) {
    ...
    const { sendSampleWebhook: result } = await api.partners.request(sendSampleWebhookMutation, token, variables);
    return result;
}
