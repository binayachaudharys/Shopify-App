 ...
 */
export async function webhookTriggerService(options) {
    const sample = await getWebhookSample(options.topic, options.apiVersion, options.deliveryMethod, options.address, options.sharedSecret);
    if (!sample.success) {
