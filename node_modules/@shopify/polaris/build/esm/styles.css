@charset "UTF-8";
:root { --polaris-version-number: '10.16.1'; }
...
.Polaris-AlphaStack { --pc-stack-gap-xs: var(--p-space-4); --pc-stack-gap-sm: var(--pc-stack-gap-xs); --pc-stack-gap-md: var(--pc-stack-gap-sm); --pc-stack-gap-lg: var(--pc-stack-gap-md); --pc-stack-gap-xl: var(--pc-stack-gap-lg); display: flex; flex-direction: var(--pc-stack-order); align-items: var(--pc-stack-align); gap: var(--pc-stack-gap-xs); }

@media (min-width: 30.625em) { .Polaris-AlphaStack { gap: var(--pc-stack-gap-sm); } }

@media (min-width: 48em) { .Polaris-AlphaStack { gap: var(--pc-stack-gap-md); } }

@media (min-width: 65em) { .Polaris-AlphaStack { gap: var(--pc-stack-gap-lg); } }

@media (min-width: 90em) { .Polaris-AlphaStack { gap: var(--pc-stack-gap-xl); } }
...
.Polaris-Checkbox__Backdrop::after { content: ''; position: absolute; z-index: 1; top: calc(var(--p-control-border-width)*-1 + -0.0625rem); right: calc(var(--p-control-border-width)*-1 + -0.0625rem); bottom: calc(var(--p-control-border-width)*-1 + -0.0625rem); left: calc(var(--p-control-border-width)*-1 + -0.0625rem); display: block; pointer-events: none; box-shadow: 0 0 0 calc(var(--p-control-border-width)*-1 + -0.0625rem) var(--p-focused); transition: box-shadow var(--p-duration-100) var(--p-ease); border-radius: var(--p-border-radius-1); }
...
.Polaris-BulkActions__ButtonGroupWrapper { width: auto; justify-content: flex-start; padding: var(--p-space-4); background: var(--p-surface); border-radius: var(--p-border-radius-2); box-shadow: var(--p-shadow-deep), var(--p-shadow-popover); max-width: 100%; }
...
.Polaris-Columns { --pc-columns-gap-xs: initial; --pc-columns-gap-sm: initial; --pc-columns-gap-md: initial; --pc-columns-gap-lg: initial; --pc-columns-gap-xl: initial; gap: var(--pc-columns-gap-xs); --pc-columns-xs: 6; --pc-columns-sm: var(--pc-columns-xs); --pc-columns-md: var(--pc-columns-sm); --pc-columns-lg: var(--pc-columns-md); --pc-columns-xl: var(--pc-columns-lg); display: grid; grid-template-columns: var(--pc-columns-xs); }
...
@media (min-width: 30.625em) { .Polaris-Columns { grid-template-columns: var(--pc-columns-sm); } }

@media (min-width: 48em) { .Polaris-Columns { grid-template-columns: var(--pc-columns-md); } }

@media (min-width: 65em) { .Polaris-Columns { grid-template-columns: var(--pc-columns-lg); } }

@media (min-width: 90em) { .Polaris-Columns { grid-template-columns: var(--pc-columns-xl); } }
...
.Polaris-Frame-Toast { display: inline-flex; max-width: 31.25rem; padding: var(--p-space-2) var(--p-space-3); border-radius: var(--p-border-radius-1); background: var(--p-surface-dark); color: var(--p-text-on-interactive); margin-bottom: var(--p-space-5); box-shadow: var(--p-shadow-popover); }
...
.Polaris-IndexTable__TableHeading { background: var(--p-surface-subdued); padding: var(--p-space-2) var(--p-space-4); text-align: left; font-weight: var(--p-font-weight-medium); color: var(--p-text-subdued); font-size: var(--p-font-size-75); white-space: nowrap; border: 0; }
...
.Polaris-IndexTable__BulkActionsWrapper { visibility: visible; position: absolute; z-index: var(--pc-index-table-bulk-actions); left: 0; width: 100%; display: flex; align-items: center; justify-content: center; margin-top: var(--p-space-4); }

.Polaris-IndexTable__BulkActionsWrapperSticky { position: fixed; top: auto; bottom: calc(var(--p-space-10) - var(--p-space-1)); }

.Polaris-IndexTable__SelectAllActionsWrapper { visibility: visible; position: relative; z-index: var(--pc-index-table-bulk-actions); top: 0; left: 0; right: 0; padding: 0 var(--p-space-2) 0 calc(var(--p-space-3) - var(--p-space-025)); background: var(--p-surface); }
...
.Polaris-CheckableButton__Checkbox { pointer-events: none; height: var(--p-choice-size); width: var(--p-choice-size); margin-left: calc(var(--p-space-2)*-1 - var(--p-control-border-width) - var(--p-border-width-1)); }
...
.Polaris-SelectAllActions { display: flex; gap: var(--p-space-025); align-items: center; justify-content: flex-start; -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: opacity; }
...
.Polaris-SelectAllActions__AllAction { font-size: var(--p-font-size-75); font-weight: var(--p-font-weight-semibold); border: 0; background: none; padding: 0; cursor: pointer; color: var(--p-interactive); position: relative; }
...
.Polaris-SelectAllActions__AllAction:focus::after { content: none; }

.Polaris-SelectAllActions__AllAction:focus:not(:active)::after { box-shadow: 0 0 0 0.125rem var(--p-focused); outline: var(--p-border-width-1) solid transparent; }
...
.Polaris-MediaCard__Popover { position: absolute; z-index: var(--p-z-2); top: var(--p-space-4); right: var(--p-space-5); }
...
.Polaris-Navigation__Badge { margin-left: var(--p-space-2); display: inline-flex; margin-top: var(--p-space-2); margin-right: var(--p-space-2); }

@media (min-width: 48em) { .Polaris-Navigation__Badge { margin-top: var(--p-space-1); } }

.Polaris-Navigation__ListItem--hasAction .Polaris-Navigation__Badge { margin-right: 0; }
...
.Polaris-Navigation__ItemInnerWrapper { display: flex; flex-wrap: nowrap; width: 100%; }

.Polaris-Navigation__ItemInnerWrapper:hover { background: var(--p-background-hovered); color: var(--p-text); text-decoration: none; }
...
.Polaris-Navigation__SecondaryAction { display: flex; align-items: center; height: 2.5rem; padding: var(--p-space-1) var(--p-space-3) var(--p-space-1) var(--p-space-4); border-radius: var(--p-border-radius-1); position: relative; }
...
.Polaris-Select__Backdrop { z-index: var(--pc-select-backdrop); top: 0; right: 0; bottom: 0; left: 0; border: var(--p-border-width-1) solid var(--p-border-shadow); border-radius: var(--p-border-radius-1); background-color: var(--p-surface); box-shadow: var(--p-shadow-button); position: relative; position: absolute; }
...
.Polaris-ResourceList__BulkActionsWrapper { z-index: 2; position: absolute; left: 0; width: 100%; display: flex; align-items: center; justify-content: center; margin-top: var(--p-space-4); }
